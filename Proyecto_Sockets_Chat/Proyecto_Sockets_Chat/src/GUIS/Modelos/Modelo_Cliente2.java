 ...
 */
public class Modelo_Cliente2{
    private Controlador_Cliente2 controlador; // Instancia del controlador del cliente1.
     ...
     */
    public Modelo_Cliente2(String ip, int puerto_mensajes, int puerto_cliente_mensajes,
                           ...
                           GUI_Cliente2 gui, Modelo_Camara modelo) throws Exception {
        this.ip = ip;
