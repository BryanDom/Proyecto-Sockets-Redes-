...
/**
 * Clase que implementa los métodos para construir la interfaz gráfica del cliente2.
 */
public class GUI_Cliente2 extends JFrame{
    ...
    private Modelo_Cliente2 cliente; // Objeto del modelo del cliente 1.
    ...
    protected Controlador_Cliente2 controlador; // Objeto del controlador del cliente1.
    ...
    /**
     * Método para inicializar los componentes y así construir la GUI del cliente2.
     */
    private void iniciarComponentes() {
        ...
        this.setTitle("Cliente Viktoria");
    ...
    /**
     * Obtiene el componente JTextArea para mostrar los mensajes enviados.
     * @return JTextArea para mensajes enviados.
     */
    ...
    /**
     * Establece el objeto Modelo_Camara para la interfaz.
     * @param c Objeto Modelo_Camara a establecer.
     */
    ...
    /**
     * Establece el objeto Controlador_Cliente2 para la interfaz.
     * @param c Objeto Controlador_Cliente2 a establecer.
     */
    public void setControlador(Controlador_Cliente2 c){
        this.controlador = c;
    }

    /**
     * Establece el objeto Modelo_Cliente2 para la interfaz.
     * @param c Objeto Modelo_Cliente2 a establecer.
     */
    public void setCliente(Modelo_Cliente2 c){
        this.cliente = c;
    }

    /**
     * Configura los argumentos necesarios en el cliente.
     * Establece los componentes de interfaz de usuario necesarios para mostrar los mensajes recibidos y enviados.
     */
    ...
    /**
     * Inicializa los componentes de la interfaz y asigna los comandos y el controlador adecuados a los botones correspondientes.
     */
